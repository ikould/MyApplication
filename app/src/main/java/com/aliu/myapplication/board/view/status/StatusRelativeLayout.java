...
public class StatusRelativeLayout extends RelativeLayout {
    ...
    public StatusRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public StatusRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
