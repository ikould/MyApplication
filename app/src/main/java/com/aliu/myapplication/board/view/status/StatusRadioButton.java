 ...
 */
public class StatusRadioButton extends AppCompatRadioButton {
    ...
    public StatusRadioButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public StatusRadioButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
